...
public class Attendance_panel_Controller extends Teacher_MainFrame_controller {
            ...
            private Button button = new Button(property);
            {
                button.setOnAction(event -> {
                    ...
                    if (Objects.equals(property, "修改")){
                        ...
                        Integer attendanceInfoId= Attendance_panel_Controller.getAttendanceInfoList().get(getIndex()).getAttendanceId();
                        DataRequest req=new DataRequest();
